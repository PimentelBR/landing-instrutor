...
const instrutoresSeed = [
  {
    ...
    sobre:
      "Sou instrutor de trânsito autônomo há 8 anos em Vila Velha. Me especializei em ajudar alunos que têm dificuldades ou medo de dirigir, criando um ambiente tranquilo e seguro para o aprendizado. Já formei mais de 200 alunos e tenho orgulho de ter uma das maiores taxas de aprovação da região.\n\nTrabalhando com veículo automático e manual, adapto o método de ensino ao ritmo de cada aluno. Ofereço aulas em Itaparica, Praia da Costa, Terra Vermelha e regiões próximas.",
    telefone: "(27) 9 9123-4567",
    email: "joao@instrutorautoc.com.br",
    alunosFormados: 214,
  ...
  },
  {
    ...
    sobre:
      "Há 5 anos formando motoristas conscientes e seguros em Vila Velha. Minha abordagem é baseada em direção defensiva — ensino não apenas a passar na prova, mas a ser um motorista seguro para toda a vida.\n\nAtendo principalmente na região de Praia da Costa, Glória e Centro de Vila Velha. Tenho veículo confortável e moderno, com duplo comando para máxima segurança.",
    telefone: "(27) 9 9234-5678",
    email: "fernanda@instrutorautoc.com.br",
    alunosFormados: 142,
    aulasRealizadas: 980,
  ...
  },
  {
    ...
    sobre:
      "Instrutor desde 2023, com foco em atender a região de Terra Vermelha, Morada da Barra e adjacências. Sou o instrutor com melhor custo-benefício da região, sem abrir mão da qualidade no ensino.\n\nEspecializado em manobras (baliza, garagem, cruzamento) e direção em estrada. Atendo fins de semana sem custo adicional.",
  ...
  },
  {
    ...
    sobre:
      "Com 6 anos de experiência, me tornei referência no atendimento a alunos que sofrem com ansiedade ao volante. Uso técnicas de respiração e relaxamento aliadas ao ensino da direção para criar uma experiência transformadora.\n\nAtualmente trabalho exclusivamente com veículo automático, que oferece mais conforto e segurança para alunos ansiosos. Atendo na região de Coqueiral, Itapuã e Barra do Jucu.",
  ...
  },
  {
    ...
    sobre:
      "Sou um dos instrutores mais experientes de Vila Velha, com 12 anos de atuação e mais de 400 alunos formados. Sou o único instrutor autônomo da região que atende tanto habilitação para carro (categoria B) quanto motocicleta (categoria A).\n\nMinha metodologia é prática e objetiva. Foco no que realmente cai no exame e nas situações que o aluno vai encontrar no dia a dia. Atendo em todo o Centro de Vila Velha.",
  ...
  },
  {
    ...
    sobre:
      "Há 7 anos trabalho com um público muito especial: além de jovens em busca da primeira habilitação, tenho grande experiência com idosos que querem renovar ou aprender a dirigir, e condutores que precisam de reciclagem.\n\nMinha abordagem é sempre tranquila, respeitosa e adaptada ao ritmo de cada aluno. Atendo principalmente na região da Glória, Polo Moda e adjacências.",
...
async function main() {
  ...
  for (const data of instrutoresSeed) {
    const { horarios, avaliacoes, ...instrutorData } = data;
    ...
    const instrutor = await prisma.instrutor.upsert({
      ...
      create: {
        ...instrutorData,
        email: instrutorData.email ?? undefined,
        senha: instrutorData.email ? senhaHash : undefined,
        horarios: {
